      ...
      <div className="container">
        <div className="footer-content">
          <div className="footer-section">
            <h3 className="footer-logo">Velora Wear</h3>
            <p className="footer-tagline">Sustainable fashion for the conscious generation</p>
        ...
        <div className="footer-bottom">
          <p>&copy; 2026 Velora Wear. All rights reserved.</p>
